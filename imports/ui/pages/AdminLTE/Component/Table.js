...
import Table from '../../../components/AdminLTE/Table/Table';
import TableItem from '../../../components/AdminLTE/Table/TableItem';
    ...
    <section className="content">
      ...
      <div className="row">
        <div className="col-md-8">
          <TableItem header={tableHeader} data={tableData} title="Striped Table" shape="striped" />
        </div>
      </div>
    </section>
  </div>
